...
/*
	获取样式：可以获取行内和非行内样式
	参数一：obj 节点名
	参数二：name 属性名	getstyle(box,'width') 只能获取
...
//--------------------------------------------
/*
   封装函数设置cookie      setCookie('like','男',7);
*/ 
...
/*
封装一个函数：取cookie 要参数，传键名，给我对应键值   getCookie('name')
*/
...
/*
删掉cookie：把时间变成过去式    removeCookie('age');
*/
